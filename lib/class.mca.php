...
<li>A <a title='Database of UBC Library licenses' target='_blank' href='http://licenses.library.ubc.ca/'>UBC License</a>, a Creative Commons license or other license permits such use
UBC holds copyright in the material.</li></ul></label></p>";
		echo "<p><input type='checkbox' name='cbcr2' value='cbcr2' id='cbcr2'> <label for='cbcr2'><strong>Public Domain:</strong> <span class='crdesc'>The material is in the <a target='_blank' href='http://copyright.ubc.ca/faq/basics/#basics8' title='More information about the public domain'>Public Domain</a></span></label></p>";
		...
		echo '<p>Maximum upload file size: '.intval(wp_max_upload_size()/1048576).'MB. After a file has been uploaded, you can add titles and descriptions.</p>';
		echo "</div>";
	}
